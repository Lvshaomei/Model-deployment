...
from siamese import Siamese as siamese
from utils import letterbox_image, preprocess_input, cvtColor, show_config
import os
...
class Siamese(object):
    ...
    model_dir = os.path.dirname(runpyp)
    model_path = os.path.join(model_dir, 'last_epoch_weights.pth')
    _defaults = {
        # -----------------------------------------------------#
    ...
    def generate(self):
        ...
        self.net = model.eval()
        print('{} code loaded.'.format(self.model_path))
