...
model.load_state_dict(torch.load(os.path.join(cur_winw,"77auc_88.113%.pkl"),map_location=torch.device('cpu')))
...
if __name__ == "__main__":
    ...
    result_save_path = r"D:\lvshaomei\face_race\my_project\result\result2"
    print(to_pred_dir)
